...
class FitrsOldIntegrationExt(IntensityIface):
  ...
  def __init__(self, params, experiments, profile_model):
    ...
    self._algorithm = IntegrationAlgorithm(
      ...
      grid_size = params.integration.intensity.fitrs_old.grid_size,
      frame_interval = params.integration.intensity.fitrs_old.reference_frame_interval,
      threshold = params.integration.intensity.fitrs_old.reference_signal_threshold)
