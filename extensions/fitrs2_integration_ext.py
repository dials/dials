...
class Fitrs2IntegrationExt(IntensityIface):
  ...
  def __init__(self, params, experiments, profile_model):
    ...
    self._algorithm = IntegrationAlgorithm(
      experiments,
      profile_model,
      grid_size=params.integration.intensity.fitrs2.grid_size,
      threshold=params.integration.intensity.fitrs2.threshold,
      debug=params.integration.intensity.fitrs2.debug)
