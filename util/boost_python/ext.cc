...
namespace dials { namespace util { namespace boost_python {
  ...
  BOOST_PYTHON_MODULE(dials_util_ext) {
    ...
    def("add_dials_batches", &add_dials_batches, (arg("mtz"), arg("dataset_id"), arg("image_range"), arg("batch_offset"), arg("wavelength"), arg("mosaic"), arg("phi_start"), arg("phi_range"), arg("cell_array"), arg("umat_array"), arg("panel_size"), arg("panel_distance"), arg("axis"), arg("s0n")));
