...
- ``dials.stills_process``: validate command-line arguments to prevent confusion
  when there is a typo (`#2106 <https://github.com/dials/dials/issues/2106>`_)
...
- Respect user supplied high resolution limit in summary table from dials.scale (`#2118 <https://github.com/dials/dials/issues/2118>`_)
- Correctly handle cases where cluster_unit_cells returns None due to only one input crystal (`#2120 <https://github.com/dials/dials/issues/2120>`_)
...
- Fix downstream SEGV involving wxPython and ``dials.image_viewer``. (`#2134 <https://github.com/dials/dials/issues/2134>`_)
