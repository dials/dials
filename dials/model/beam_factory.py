...
class BeamFactory:
    ...
    def simple(wavelength):
        ...
        return Beam(wavelength, (0.0, 0.0, 1.0), (0.0, 1.0, 0.0), 0.999)
    ...
    def complex(beam_direction, polarization_fraction,
        ...
        return Beam(wavelength, beam_direction,
    ...
    def imgCIF_H(cbf_handle):
        ...
        return Beam(wavelength, direction, polar_plane_normal, polar_fraction)
