...
class SpotFinderWrapper(object):
...
class SpotFinderFactory(object):
    ...
    def from_parameters(params):
        ...
        return SpotFinderWrapper(find_spots, params.spotfinder.scan_range)
    ...
    def configure_algorithm(params):
        ...
        if params.spotfinder.threshold.algorithm == 'lui':
            return SpotFinderFactory.configure_lui_spotfinder(params)
        else:
            return SpotFinderFactory.configure_general_spotfinder(params)
