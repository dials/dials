...
ref2d = model_2d(150, 150, 10, 20, 0.333333, 25, 0.1)
dat2d_paint = ref2d.as_numpy_array()
plt.imshow(dat2d_paint , interpolation = "nearest")
plt.show()

ref2d = model_2d(150, 150, 10, 20, 0.333333, 25, 0.5)
dat2d_paint = ref2d.as_numpy_array()
plt.imshow(dat2d_paint , interpolation = "nearest")
plt.show()


ref2d = model_2d(150, 150, 10, 20, 0.333333, 25, 0.9)
dat2d_paint = ref2d.as_numpy_array()
plt.imshow(dat2d_paint , interpolation = "nearest")
plt.show()
