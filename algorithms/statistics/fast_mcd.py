  ...
  van Driessen"""
    ...
    and perform initial trials within each of these, then merge"""
        ...
        if size <= 100000:
            ...
            k4 = 7
        elif size > 500000 and size <= 600000:
            k4 = 6
        elif size > 600000 and size <= 700000:
            k4 = 5
        elif size > 700000 and size <= 800000:
            k4 = 4
        elif size > 800000 and size <= 900000:
            k4 = 3
        elif size > 900000 and size <= 1000000:
            k4 = 2
        else:
            k4 = 1
