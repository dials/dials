...
class PerImageCChalfStatistics(object):
    ...
    def __init__(
        ...
        for h in list(index_lookup.keys()):
        ...
        self._num_unique = len(list(reflection_sums.keys()))
    ...
    def _compute_cchalf(self, reflection_sums, binner):
        ...
        for h in list(reflection_sums.keys()):
    ...
    def _compute_cchalf_excluding_each_dataset(
        ...
        cchalf_i = {}
        for dataset in list(dataset_lookup.keys()):
