...
class xds_target_function(target_function):
  ...
  def calculate_gradient(self):
    ...
    dIhdg = ((intensities) - (Ih_values * 2.0 * scale_factors)) / (variances * sumgsq)
    ...
    '''print list(rhl)[22100:22120]
    print list(grad)[22100:22120]
    print list(Ih_values)[22100:22120]
    print list(scale_factors)[22100:22120]
    print list(dIhdg)[22100:22120]
    print list(scaleweights)[22100:22120]
    exit()'''
