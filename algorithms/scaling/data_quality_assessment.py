def R_meas(Data_Manager_object):
    Ihl = Data_Manager_object.sorted_reflections[Data_Manager_object.int_str]
    ...
    for h in range(Data_Manager_object.n_unique_indices):
        ...
        if lsum > 1:
            for i in range(lsum):
                ...
                (h, l, a, xy) = Data_Manager_object.bin_index_array[indexer]
                a1 += abs((Ihl[indexer]/(g_values[l]*g2_values[a]*g3_values[xy]))
                          - Ih_array[h])
