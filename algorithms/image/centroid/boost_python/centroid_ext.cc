...
namespace dials { namespace algorithms { namespace boost_python {
  ...
  class_<CentroidPoints<FloatType, CoordType> >
  centroid_points_wrapper(const char *name) {
  ...
  void centroid_image_2d_wrapper(const char *name) {
    ...
    class_<CentroidImage2d<FloatType>, bases<CentroidPointsType> >(
        name, no_init)
  ...
  void centroid_image_3d_wrapper(const char *name) {
    ...
    class_<CentroidImage3d<FloatType>, bases<CentroidPointsType> >(
        name, no_init)
  ...
  void centroid_masked_image_2d_wrapper(const char *name) {
    ...
    class_<CentroidMaskedImage2d<FloatType>, bases<CentroidPointsType> >(
        name, no_init)
      .def(init<const af::const_ref<FloatType, af::c_grid<2> >&,
  ...
  void centroid_masked_image_3d_wrapper(const char *name) {
    ...
    class_<CentroidMaskedImage3d<FloatType>, bases<CentroidPointsType> >(
        name, no_init)
      .def(init<const af::const_ref<FloatType, af::c_grid<3> >&,
  ...
  void centroid_suite() {
    ...
    def("centroid_image",
      &centroid_image_2d<FloatType>, (
        arg("image")));

    def("centroid_image",
      &centroid_image_3d<FloatType>, (
        arg("image")));
