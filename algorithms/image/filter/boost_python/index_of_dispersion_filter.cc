...
namespace dials { namespace algorithms { namespace boost_python {
  ...
  void index_of_dispersion_filter_suite() {
    def("index_of_dispersion_filter", &make_index_of_dispersion_filter<FloatType>, (
      arg("image"),
      arg("kernel")));

    def("index_of_dispersion_filter", &make_index_of_dispersion_filter_masked<FloatType>, (
      arg("image"),
      arg("mask"),
      arg("kernel"),
      arg("min_count")));
  ...
  void export_index_of_dispersion_filter() {
    ...
    index_of_dispersion_filter_masked_wrapper<float>("IndexOfDispersionFilterMaskedFloat");
    index_of_dispersion_filter_masked_wrapper<double>("IndexOfDispersionFilterMaskedDouble");
