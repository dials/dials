...
0.922       10.00  1.00  ***   3^-1 |(1, 1, 1)
0.087       1.96   0.20        2 |(-1, 1, 0)
0.922       10.00  1.00  ***   3 |(1, 1, 1)
----------------------------------------------
Scoring all possible sub-groups
--------------------------------------------------------------------------------
Patterson group       Likelihood  NetZcc  Zcc+    Zcc-   delta  Reindex operator
--------------------------------------------------------------------------------
R -3 :H          ***  0.990        8.04    10.00   1.96  0.0    b-c,-a+c,a+b+c
P -1                  0.007       -6.50    0.00    6.50  0.0    a,b,c
R -3 m :H             0.001        6.50    6.50    0.00  0.0    b-c,-a+c,a+b+c
C 1 2/m 1             0.001       -5.24    1.96    7.21  0.0    -a-b,a-b,c
C 1 2/m 1             0.001       -5.24    1.96    7.21  0.0    -b-c,b-c,a
C 1 2/m 1             0.001       -5.24    1.96    7.21  0.0    -a-c,-a+c,b
--------------------------------------------------------------------------------
Best solution: R -3 :H
