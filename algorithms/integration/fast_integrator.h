...
/*     /** Arbitrary constant to limit size of measurement box. *1/ */
...
/*         /1* profile_model_[id].apply(mask, bbox); *1/ */

/*         // Do the background subtraction */
/*         /1* background::PlaneModel background(data, mask, 1.0, 3.0); *1/ */
/*         /1* for (std::size_t j = 0; j < bgrd.accessor()[0]; ++j) { *1/ */
/*         /1*   for (std::size_t i = 0; i < bgrd.accessor()[1]; ++i) { *1/ */
/*         /1*     bgrd(j,i) = background.value(j, i); *1/ */
/*         /1*   } *1/ */
/*         /1* } *1/ */
