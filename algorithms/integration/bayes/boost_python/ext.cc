  ...
  void bayesian_integrator_wrapper(const char *name)
  {
    ...
    class_ <BayesianIntegratorType> (name, no_init)
      ...
      .def(init <const af::const_ref< FloatType, af::c_grid<3> >&,
          ...
          arg("mask"))))
      .def("intensity",
        &BayesianIntegratorType::intensity)
      .def("variance",
        &BayesianIntegratorType::variance)
      .def("background",
        &BayesianIntegratorType::background)
      .def("background_variance",
        &BayesianIntegratorType::background_variance)
      .def("n_signal",
        &BayesianIntegratorType::n_signal)
      .def("n_background",
        &BayesianIntegratorType::n_background)
      .def("success",
        &BayesianIntegratorType::success)
      ;
  }
