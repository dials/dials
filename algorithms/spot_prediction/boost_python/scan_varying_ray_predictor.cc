...
namespace dials { namespace algorithms { namespace boost_python {
  ...
  static
  object predict1(const ScanVaryingRayPredictor &predictor,
  ...
  static
  object predict2(const ScanVaryingRayPredictor &predictor,
      const cctbx::miller::index<> &h,
      const mat3<double> &A1, const mat3<double> &A2,
      const vec3<double> &s0a, const vec3<double> &s0b,
      int image, std::size_t step) {
  ...
  void export_scan_varying_ray_predictor()
  {
    ...
    class_ <ScanVaryingRayPredictor> ("ScanVaryingRayPredictor", no_init)
      .def(init <vec3<double>,
        ...
        arg("dphi"),
        arg("dmin"))))
      .def("__call__", &predict1, (
        arg("hkl"),
        arg("A1"),
        arg("A2"),
        arg("image"),
        arg("step") = 1))
      .def("__call__", &predict2, (
        arg("hkl"),
        arg("A1"),
        arg("A2"),
        arg("s0a"),
