...
from dials.algorithms.refinement.parameterisation \
    import phil_str as parameterisation_phil_str
...
class RefinerFactory(object):
  ...
  @classmethod
  def config_parameterisation(cls, options, experiments, refman,
      do_stills=False):
  ...
  def config_restraints(params, pred_param):
    ...
    if not any([params.crystal.unit_cell.restraints.tie_to_target,
