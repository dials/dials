...
def make_test_data_ptp1b_31c():
    ...
    i = [-0.002, -0.018, 1765.107, 0.049, 0.206, 538.946, 0.065, 0.068, 511.518]
    i += [0.008, 0.295, 46.878, -0.106, 0.374, 118.479, 0.509, 0.554, 84.699]
    i += [0.084, 0.335, 413.968, -0.371, 0.144, 65.366, -0.185, 30.277, 0.283]
    i += [1.785, 9.957, 1.041, 0.3, 2.142, 0.199, 0.118, 8.955, 0.269, 0.744]
    i += [2.981, -0.575, 0.26, -0.41, 0.032, -0.294, 71.932, 0.028, 17.147, 1.246]
    s = [0.007, 0.05, 3.662, 0.125, 0.14, 2.866, 0.232, 0.242, 3.421, 0.321]
    s += [0.381, 1.236, 0.397, 0.465, 2.174, 0.478, 0.595, 2.072, 0.624, 0.693]
    s += [4.767, 0.807, 0.787, 4.427, 0.955, 1.806, 1.125, 1.13, 1.367, 1.259]
    s += [1.287, 1.203, 1.153, 1.341, 1.506, 1.128, 1.344, 1.381, 1.16, 1.26]
    s += [1.363, 1.194, 1.224, 3.229, 1.286, 3.01, 1.487]
