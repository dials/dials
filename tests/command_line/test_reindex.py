...
def test_reindex(dials_regression: Path, tmpdir):
...
def test_reindex_multi_sequence(dials_regression: Path, tmpdir):
...
def test_reindex_against_reference(dials_regression: Path, tmpdir):
