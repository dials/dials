...
def load_source(modname, filename):
    """Replacement for imp.load_source, from python documentation"""
...
class SetupInstaller(object):
    def __init__(self, **kwargs):
        ...
        installer_module = load_source("install_script", self.install_script)
        ...
        if self.base_dir == "conda_base":
            ...
            try:
                subprocess.check_output(
                    ["conda", "pack", "-h"], stderr=subprocess.STDOUT, env=env
                )
