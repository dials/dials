...
def test_1(dials_data, run_in_tmpdir):
    ...
    commands = [
        ...
        "dials.slice_sweep imported_experiments.expt image_range=80,90",
        "dials.find_spots imported_experiments_80_90.expt",
        "dials.index imported_experiments_80_90.expt strong.refl space_group=P41212",
