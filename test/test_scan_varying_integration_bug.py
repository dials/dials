...
def test_1(dials_data, run_in_tmpdir):
    ...
    commands = [
        ...
        "dials.index imported_experiments_80_90.json strong.mpack space_group=P41212",
        "dials.refine indexed_experiments.json indexed.mpack scan_varying=True",
        "dials.integrate refined_experiments.json indexed.mpack",
        "dials.export refined_experiments.json integrated.mpack partiality_threshold=0.99",
    ]
