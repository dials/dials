...
class Test_Centroid(object):
  ...
  def calculate_gold2d(cls):
    ...
    cls.gold2dubvar = matrix.col((xc.gsl_stats_wvariance(),
  ...
  def calculate_gold3d(cls):
    ...
    cls.gold3dubvar = matrix.col((xc.gsl_stats_wvariance(),
                                   yc.gsl_stats_wvariance(),
  ...
  def calculate_gold_masked2d(cls):
    ...
    cls.goldmasked2dubvar = matrix.col((xc.gsl_stats_wvariance(),
                                         yc.gsl_stats_wvariance()))
  ...
  def calculate_gold_masked3d(cls):
    ...
    cls.goldmasked3d = matrix.col((f_tot / d_tot,
    ...
    cls.goldmasked3dubvar = matrix.col((xc.gsl_stats_wvariance(),
                                         yc.gsl_stats_wvariance(),
                                         zc.gsl_stats_wvariance()))
