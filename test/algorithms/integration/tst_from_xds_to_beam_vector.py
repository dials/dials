...
from dials.algorithms.integration import FromXdsToBeamVector

class TestFromXdsToBeamVector(object):
    """Test the FromXdsToBeamVector class"""
    ...
    def test_xds_origin(self):
        ...
        eps = 1e-7
        s_dash = self.from_xds_to_beam_vector((0, 0, 0))
    ...
    def test_far_out_coordinates(self):
        ...
        c1 = 1.0 - eps
        s_dash = self.from_xds_to_beam_vector((c1, c2, c3))
    ...
    def test_forward_and_reverse_transform(self):
        ...
        for i in range(num):
            ...
            s_dash_2 = self.from_xds_to_beam_vector((c1, c2, c3))
