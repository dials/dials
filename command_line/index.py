...
program dials.find_spots. The program is called with a "experiments.expt" file
...
Examples::
  ...
  dials.index experiments.expt strong.refl

  dials.index experiments.expt strong.refl unit_cell=37,79,79,90,90,90 space_group=P43212

  dials.index experiments.expt strong.refl indexing.method=fft1d
