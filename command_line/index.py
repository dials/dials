...
Examples::
  ...
  dials.index experiments.json strong.refl

  dials.index experiments.json strong.refl unit_cell=37,79,79,90,90,90 space_group=P43212

  dials.index experiments.json strong.refl indexing.method=fft1d
