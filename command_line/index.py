...
(as generated by dials.import) and a "strong.mpack" file (as generated by
...
crystal model(s), and an "indexed.mpack" file which is similar to the input
"strong.mpack" file, but with the addition of miller indices and predicted
spot centroids.
...
Examples::
  ...
  dials.index experiments.json strong.mpack

  dials.index experiments.json strong.mpack unit_cell=37,79,79,90,90,90 space_group=P43212

  dials.index experiments.json strong.mpack indexing.method=fft1d
