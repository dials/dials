...
Examples::
  ...
  dials.compare_orientation_matrices experiments.expt

  dials.compare_orientation_matrices experiments_1.expt experiments_2.expt

  dials.compare_orientation_matrices experiments_1.expt experiments_2.expt hkl=1,0,0
