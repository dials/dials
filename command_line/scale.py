...
The program outputs one scaled.refl and scaled_experiments.json file, which
...
The scaling models determined by this program can be plotted with::
  ...
  dials.plot_scaling_models scaled.refl scaled_experiments.json

Example use cases

Regular single-sweep scaling, with no absorption correction::

  dials.scale integrated.refl integrated_experiments.json absorption_term=False

Scaling multiple datasets, specifying scale parameter interval::

  dials.scale 1_integrated.refl 1_integrated_experiments.json 2_integrated.refl 2_integrated_experiments.json scale_interval=10.0

Incremental scaling (with different options per dataset)::

  dials.scale integrated.refl integrated_experiments.json scale_interval=10.0

  dials.scale integrated_2.refl integrated_experiments_2.json scaled.refl scaled_experiments.json scale_interval=15.0
...
def run(args=None):
    ...
    usage = """Usage: dials.scale integrated.refl integrated_experiments.json
[integrated.refl(2) integrated_experiments.json(2) ....] [options]"""
