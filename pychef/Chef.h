...
namespace dials { namespace pychef {
  ...
  public:
    ...
    scitbx::af::shared<std::size_t> iplus() { return iplus_; }

    scitbx::af::shared<std::size_t> iminus() { return iminus_; }

    cctbx::miller::index<> miller_index() { return miller_index_; }

    bool is_centric() { return centric_; }
  ...
  struct Observations
  {
      ...
      bool anomalous_flag)
    {
      ...
      scitbx::af::shared<cctbx::miller::index<> > asu_indices(
        miller_indices.begin(), miller_indices.end());
    ...
    map_type observation_groups() { return observation_groups_; }
  ...
  namespace accumulator {
    ...
    class CompletenessAccumulator
    {
      ...
      private:
        ...
        af::shared<double>
        iplus_comp_overall, iminus_comp_overall,
        ieither_comp_overall, iboth_comp_overall;
    ...
    class RcpScpAccumulator
    {
      ...
      private:
        ...
        af::versa<double, af::c_grid<2> >
        A, B, isigma, rcp_bins_, scp_bins_;
