...
shifted_det_p_vals = [a + b for a, b in zip(det_p_vals,
                                [1.0, 1.0, 1.0, 2., 2., 2.])]
det_param.set_param_vals(shifted_det_p_vals)
...
s0_param.set_param_vals(shifted_s0_p_vals)

# rotate crystal a bit (=2 mrad each rotation)
xlo_p_vals = xlo_param.get_param_vals()
shifted_xlo_p_vals = [a + b for a, b in zip(xlo_p_vals, [2., 2., 2.])]
xlo_param.set_param_vals(shifted_xlo_p_vals)
...
xluc_param.set_param_vals(shifted_xluc_p_vals)
