...
class Grid:
    ...
    def __init__(self, num_grids, grid_size=None, grid_origin=None,
        ...
        if step_size == None:
            ...
            step_size = self._calculate_step_size(sigma_divergence,
                                                  sigma_mosaicity)
        ...
        grid_shape = (num_grids,) + grid_size
    ...
    def _calculate_step_size(self, sigma_divergence, sigma_mosaicity):
        ...
        """
        return (1.0, 1.0, 1.0) # TODO - Fix step size calculation
