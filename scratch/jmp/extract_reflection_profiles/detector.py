...
class Detector:
    """A class to hold all the detector data."""

    def __init__(self, image, d1, d2, d3, distance, pixel_origin, pixel_size):
        """Initialise the detector.

        Args:
            image: The detector image volume
            d1: The detector x axis unit vector
            d2: The detector y axis unit vector
            d3: The detector normal unit vector
            distance: The distance from the crystal to the detector
        ...
        # Create the detector coordinate system
        self.coordinate_system = CoordinateSystem(d1, d2, d3, distance,
